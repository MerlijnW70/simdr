...
| --- | --- | --- |
| **Unit tests** | whatever `cargo test --workspace` prints — the number is deliberately **not** written here, because it was 348, then 740, then 451, then 822, and each of those was wrong within days of being typed | Everything cheap |
