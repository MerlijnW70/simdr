...
| --- | --- | --- |
| **Unit tests** | 451 in the emitter, decoding what was emitted; 822 across the workspace — `cargo test --workspace` prints both, and these were 348 and 740 until somebody counted again | Everything cheap |
